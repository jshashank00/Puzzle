...
public class PuzzlePiece {
    ...
    public PuzzlePiece getDragging() {
        return dragging;
    }
...
// Make relative to the location and size to the piece size
    ...
    public boolean isSnapped() {
        float dxSquared = (x - finalX) * (x - finalX);
        float dySquared = (y - finalY) * (y - finalY);

        float snapDistanceSquared = SNAP_DISTANCE * SNAP_DISTANCE;

        return dxSquared < snapDistanceSquared && dySquared < snapDistanceSquared;
    }
